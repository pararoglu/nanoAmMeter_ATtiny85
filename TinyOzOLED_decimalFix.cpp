...
if (f < 0.1){ // JD adding these lines so that if the fraction was .06, the OLED will not print .6
printChar('0');
num_extra++;
} 
...
// ***********Aug 21 2021: JD adding this addition from: https://oscarliang.com/arduino-oled-display-library/ 
void OzOLED::printStringX2(const char *String, byte X, byte Y, byte numChar){
byte count=0;
while(String[count] && count<numChar){
printCharX2(String[count++],(X+count),Y);
}
}
// ***********Aug 21 2021: JD adding this addition from: https://oscarliang.com/arduino-oled-display-library/ 
